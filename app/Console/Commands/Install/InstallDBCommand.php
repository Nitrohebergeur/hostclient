...
class InstallDBCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'Hostclient:install-db {--username=} {--password=} {--database=} {--host=} {--port=}';
     ...
     * @var string
     */
    protected $description = 'Install the database for the Hostclient application (warning : this will drop all tables)';
