...
class CreateAdminCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'Hostclient:install-admin {--email=} {--password=} {--firstname=} {--lastname=}';
     ...
     * @var string
     */
    protected $description = 'Create the admin user for the Hostclient application';
