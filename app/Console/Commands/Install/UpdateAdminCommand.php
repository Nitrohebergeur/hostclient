...
class UpdateAdminCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'Hostclient:update-admin {id} {--email=} {--password=} {--firstname=} {--lastname=}';
     ...
     * @var string
     */
    protected $description = 'Update the admin user for the Hostclient application';
