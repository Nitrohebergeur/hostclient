...
class CreateThemeCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'Hostclient:create-theme {--name=: Theme name}
    {--uuid= : Theme UUID}
     ...
     * @var string
     */
    protected $description = 'Create a new theme for the Hostclient.';
    ...
    public function handle()
    {
        ...
        $description = $this->option('description') ?: $this->ask('What is the description of the theme?', "A theme for Hostclient named $name.");
