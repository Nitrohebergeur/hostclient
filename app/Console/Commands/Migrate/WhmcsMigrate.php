...
class WhmcsMigrate extends Command
{
     ...
     * @var string
     */
    protected $signature = 'Hostclient:whmcs-migrate {--skip-pending=true} {--all=false} {--dbname=whmcs} {--host=localhost} {--username=root} {--password=root} {--port=3306} {--force} {--key=whmcs} {--wisp} {--products} {--groups} {--servers} {--services} {--clients} {--pterodactyl} {--invoices}';
     ...
     * @var string
     */
    protected $description = 'Migrate WHMCS data to Hostclient';
