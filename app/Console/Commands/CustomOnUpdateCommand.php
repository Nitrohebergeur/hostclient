...
class CustomOnUpdateCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'Hostclient:on-custom-update';
     ...
     * @var string
     */
    protected $description = 'On custom update command for Hostclient.';
    ...
    public function handle()
    {
        ...
        $this->info('Hostclient is up to date.');
    }
