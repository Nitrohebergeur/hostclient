<?php $__env->startSection('title', 'Détail du Service'); ?>
                ...
                <div class="card-body p-0">
                    <div class="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <div class="flex items-center gap-4 p-4">
                            <span class="flex-shrink-0 w-2 h-2 rounded-full <?php echo e($log[2] === 'success' ? 'bg-success-500' : 'bg-primary-500'); ?>"></span>
                            <span class="flex-1 text-sm text-gray-900 dark:text-white"><?php echo e($log[0]); ?></span>
                            <span class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($log[1]); ?></span>
                        </div>
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/hostclient/resources/views/client/services/show.blade.php ENDPATH**/ ?>