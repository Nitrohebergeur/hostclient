<?php $__env->startSection('title', 'Tickets Support'); ?>
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label, $count, $color, $urgent]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="card <?php echo e($urgent ? 'border-2 border-warning-400 dark:border-warning-600' : ''); ?>">
            <div class="card-body py-4 flex items-center gap-4">
                <p class="text-3xl font-bold text-<?php echo e($color); ?>-600 dark:text-<?php echo e($color); ?>-400"><?php echo e($count); ?></p>
                <div>
                    <p class="text-sm font-medium text-gray-700 dark:text-gray-300"><?php echo e($label); ?></p>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($urgent): ?> <p class="text-xs text-warning-600 dark:text-warning-400">Nécessite attention</p> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
        </div>
    ...
    <div class="card">
        <div class="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$id, $subj, $client, $cat, $prio, $status, $agent, $time, $replied]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="/admin/tickets/<?php echo e($id); ?>" class="flex items-start sm:items-center gap-3 px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">

                <!-- Priority dot -->
                <span class="flex-shrink-0 mt-2 sm:mt-0 w-3 h-3 rounded-full
                    <?php echo e($prio === 'urgent' ? 'bg-danger-600 animate-pulse ring-2 ring-danger-300' : ($prio === 'high' ? 'bg-danger-400 animate-pulse' : 'bg-warning-400')); ?>">
                </span>
                ...
                <div class="flex-1 min-w-0">
                    <div class="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                        <p class="font-semibold text-gray-900 dark:text-white group-hover:text-primary-600 dark:group-hover:text-primary-400">
                            #<?php echo e($id); ?> — <?php echo e($subj); ?>

                        </p>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$replied): ?>
                ...
                <div class="flex items-center gap-2 flex-shrink-0">
                    ...
                    <?php else: ?>                           <span class="badge badge-danger">En attente</span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <div x-data="dropdown" class="relative" @click.stop>
                        ...
                        <div x-show="open" @click.away="close" x-transition class="absolute right-0 z-10 mt-1 w-44 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-1">
                            <a href="/admin/tickets/<?php echo e($id); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">Ouvrir</a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/hostclient/resources/views/admin/tickets/index.blade.php ENDPATH**/ ?>