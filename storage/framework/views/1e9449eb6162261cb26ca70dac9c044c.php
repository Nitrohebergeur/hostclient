            ...
            <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                <div x-data="dropdown" class="relative">
                    <button @click="toggle" class="flex items-center gap-3 w-full px-4 py-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                        <img src="https://ui-avatars.com/api/?name=<?php echo e(auth()->user()->name ?? 'User'); ?>&background=0ea5e9&color=fff" alt="Profile" class="w-10 h-10 rounded-full">
                        <div class="flex-1 text-left">
                            <div class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e(auth()->user()->name ?? 'User'); ?></div>
                            <div class="text-xs text-gray-500 dark:text-gray-400"><?php echo e(auth()->user()->email ?? 'user@example.com'); ?></div>
                        </div>
            ...
            <header class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-30">
                <div class="px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <h1 class="text-xl font-bold text-gray-900 dark:text-white"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h1>
                    </div>
...
<?php /**PATH /var/www/hostclient/resources/views/layouts/client.blade.php ENDPATH**/ ?>