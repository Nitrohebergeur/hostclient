...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg shadow-lg p-8 mb-8 text-white">
        <h1 class="text-3xl font-bold mb-2">Bienvenue, <?php echo e(auth()->user()->first_name); ?> !</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <a href="<?php echo e(route('client.services.index')); ?>" class="text-sm text-blue-600 dark:text-blue-400 hover:underline mt-3 block">
                Voir mes services →
            </a>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:text-white mt-2">
                        <?php echo e($stats['unpaid_invoices'] ?? 0); ?>
            ...
            <a href="<?php echo e(route('client.invoices.index')); ?>" class="text-sm text-blue-600 dark:text-blue-400 hover:underline mt-3 block">
                Voir mes factures →
            </a>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <a href="<?php echo e(route('client.tickets.index')); ?>" class="text-sm text-blue-600 dark:text-blue-400 hover:underline mt-3 block">
                Voir mes tickets →
            </a>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
            ...
            <div class="p-6 space-y-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentServices ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($service->name); ?></p>
                                <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($service->product->name); ?></p>
                            </div>
                        </div>
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($service->status === 'active' ? 'bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-300' : 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300'); ?>">
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="text-center py-12">
                        ...
                        <a href="<?php echo e(route('store.index')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400">Échéance: <?php echo e($invoice->due_date->format('d/m/Y')); ?></p>
                            </div>
                        </div>
                        <div class="text-right">
                            <p class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e(number_format($invoice->total, 2)); ?> €</p>
                            <span class="inline-flex items-center px-2 py-1 text-xs font-medium rounded-full <?php echo e($invoice->status === 'paid' ? 'bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900/20 dark:text-red-300'); ?>">
                                <?php echo e($invoice->status === 'paid' ? 'Payée' : 'Impayée'); ?>
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /root/hostclient/resources/views/client/dashboard.blade.php ENDPATH**/ ?>