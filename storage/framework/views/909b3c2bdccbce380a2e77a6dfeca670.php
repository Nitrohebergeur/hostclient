...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> — HostClient Admin</title>
    ...
    >
        ...
        <nav class="flex-1 overflow-y-auto scrollbar-thin py-4 px-3 space-y-0.5">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $nav; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($item['divider'])): ?>
                    <p class="px-3 pt-4 pb-1 text-xs font-semibold text-gray-500 uppercase tracking-wider"><?php echo e($item['divider']); ?></p>
                <?php else: ?>
                    <?php $active = request()->is($item['route'].'*'); ?>
                    <a href="/<?php echo e($item['route']); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors
                              <?php echo e($active
                                 ? 'bg-primary-600 text-white shadow'
                                 : 'text-gray-400 hover:bg-gray-800 hover:text-gray-100'); ?>">
                        <?php echo $__env->make('layouts.partials.admin-icon', ['icon' => $item['icon']], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($item['badge'])): ?>
                            <span class="ml-auto bg-danger-500 text-white text-xs font-bold px-1.5 py-0.5 rounded-full"><?php echo e($item['badge']); ?></span>
        ...
        <div class="border-t border-gray-800 p-3">
            <div x-data="dropdown" class="relative">
                <button @click="toggle" class="flex items-center gap-3 w-full px-3 py-2 rounded-lg hover:bg-gray-800 transition-colors">
                    <img src="https://ui-avatars.com/api/?name=<?php echo e(auth()->user()->name ?? 'Admin'); ?>&background=d946ef&color=fff&size=36"
                         class="w-9 h-9 rounded-full flex-shrink-0" alt="Admin">
                    <div class="text-left overflow-hidden">
                        <p class="text-sm font-medium text-white truncate"><?php echo e(auth()->user()->name ?? 'Administrateur'); ?></p>
        ...
        <header class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-30">
            <div class="px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <h1 class="text-lg font-bold text-gray-900 dark:text-white"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h1>
                </div>
                    ...
                    <div x-data="dropdown" class="relative">
                        ...
                        <div x-show="open" @click.away="close" x-transition class="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
                            ...
                            <a href="#" class="flex gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                <span class="flex-shrink-0 mt-1 w-2 h-2 rounded-full bg-<?php echo e($notif[2]); ?>-500"></span>
                                <div class="flex-1 min-w-0">
                                    <p class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($notif[0]); ?></p>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 truncate"><?php echo e($notif[1]); ?></p>
                                </div>
                                <span class="text-xs text-gray-400 flex-shrink-0"><?php echo e($notif[2] === 'danger' ? $notif[3] : $notif[3]); ?></span>
                            </a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH /var/www/hostclient/resources/views/layouts/admin.blade.php ENDPATH**/ ?>