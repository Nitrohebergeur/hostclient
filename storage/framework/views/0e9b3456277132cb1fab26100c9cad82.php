<?php $__env->startSection('title', 'Profil Utilisateur'); ?>
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$val, $label, $color, $path]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="card">
            <div class="card-body py-4 flex items-center gap-3">
                <div class="w-10 h-10 bg-<?php echo e($color); ?>-100 dark:bg-<?php echo e($color); ?>-900/30 rounded-lg flex items-center justify-center flex-shrink-0">
                    <svg class="w-5 h-5 text-<?php echo e($color); ?>-600 dark:text-<?php echo e($color); ?>-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($path); ?>"/></svg>
                </div>
                <div>
                    <p class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e($val); ?></p>
                    <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($label); ?></p>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body space-y-3 text-sm">
                    ...
                    <div class="flex justify-between items-start gap-2">
                        <span class="text-gray-500 dark:text-gray-400 flex-shrink-0"><?php echo e($k); ?></span>
                        <span class="text-gray-900 dark:text-white font-medium text-right"><?php echo e($v); ?></span>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
            ...
            <div x-data="{ tab: 'services' }">
                <div class="border-b border-gray-200 dark:border-gray-700">
                    <nav class="flex -mb-px overflow-x-auto">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['services' => 'Services (12)', 'invoices' => 'Factures (24)', 'tickets' => 'Tickets (18)', 'activity' => 'Activité']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button @click="tab = '<?php echo e($k); ?>'" :class="tab === '<?php echo e($k); ?>' ? 'border-primary-500 text-primary-600 dark:text-primary-400' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400'" class="px-5 py-3 text-sm font-medium border-b-2 whitespace-nowrap transition-colors"><?php echo e($l); ?></button>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </nav>
                </div>
                        ...
                        <div class="overflow-x-auto">
                            <table class="table w-full">
                                ...
                                <tbody>
                                    ...
                                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$name, $host, $type, $price, $renew, $status]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <p class="font-medium text-gray-900 dark:text-white text-sm"><?php echo e($name); ?></p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($host); ?></p>
                                        </td>
                                        <td class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($type); ?></td>
                                        <td class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e($price); ?></td>
                                        <td class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($renew); ?></td>
                                        <td>
                                            ...
                                            <?php else: ?> <span class="badge badge-warning">Suspendu</span>
                        ...
                        <div class="overflow-x-auto">
                            <table class="table w-full">
                                ...
                                <tbody>
                                    ...
                                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$num, $date, $amount, $gw, $status]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><a href="/admin/invoices/1" class="text-primary-600 dark:text-primary-400 font-mono text-sm hover:underline">#<?php echo e($num); ?></a></td>
                                        ...
                                        <td><span class="text-xs bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-2 py-0.5 rounded-full"><?php echo e($gw); ?></span></td>
                                        <td>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($status === 'paid'): ?> <span class="badge badge-success">Payée</span>
                                            <?php else: ?> <span class="badge badge-warning">En attente</span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </td>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div x-show="tab === 'tickets'" class="mt-4">
                    <div class="card divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$id, $subj, $cat, $status, $time]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="/admin/tickets/<?php echo e($id); ?>" class="flex items-center justify-between px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                            <div>
                                <p class="text-sm font-medium text-gray-900 dark:text-white">#<?php echo e($id); ?> — <?php echo e($subj); ?></p>
                                <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($cat); ?> · <?php echo e($time); ?></p>
                            </div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($status === 'open'): ?> <span class="badge badge-warning">Ouvert</span>
                            <?php elseif($status === 'in_progress'): ?> <span class="badge badge-primary">En cours</span>
                            <?php else: ?> <span class="badge badge-success">Fermé</span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="space-y-4">
                                ...
                                ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$desc, $time, $color]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex gap-3 items-start">
                                    <span class="flex-shrink-0 mt-2 w-2 h-2 rounded-full bg-<?php echo e($color); ?>-500"></span>
                                    <div class="flex-1">
                                        <p class="text-sm text-gray-900 dark:text-white"><?php echo e($desc); ?></p>
                                        <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($time); ?></p>
                                    </div>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/hostclient/resources/views/admin/users/show.blade.php ENDPATH**/ ?>