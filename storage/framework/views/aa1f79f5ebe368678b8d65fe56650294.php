...
<head>
    ...
    <title>Inscription - <?php echo e(config('app.name')); ?></title>
    ...
    <div class="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <div class="mt-6 text-center">
                <a href="<?php echo e(route('home')); ?>" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white flex items-center justify-center">
...
<?php /**PATH /root/hostclient/resources/views/auth/register.blade.php ENDPATH**/ ?>