...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-5 gap-4">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [
            ...
            ['8','Résiliés','gray'],
            ['402','Total','primary'],
        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$count, $label, $color]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="card">
            <div class="card-body py-4 text-center">
                <p class="text-2xl font-bold text-<?php echo e($color); ?>-600 dark:text-<?php echo e($color); ?>-400"><?php echo e($count); ?></p>
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1"><?php echo e($label); ?></p>
            </div>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="table w-full">
                ...
                <tbody>
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$client, $product, $ident, $module, $price, $renew, $status]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><input type="checkbox" class="w-4 h-4 rounded"></td>
                        <td>
                            <a href="/admin/users/1" class="font-medium text-primary-600 dark:text-primary-400 text-sm hover:underline"><?php echo e($client); ?></a>
                        </td>
                        <td class="text-sm text-gray-900 dark:text-white font-medium"><?php echo e($product); ?></td>
                        <td class="font-mono text-xs text-gray-600 dark:text-gray-400"><?php echo e($ident); ?></td>
                        <td><span class="text-xs bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-2 py-0.5 rounded-full"><?php echo e($module); ?></span></td>
                        <td class="font-semibold text-sm text-gray-900 dark:text-white"><?php echo e($price); ?></td>
                        <td class="text-sm <?php echo e($status === 'active' && strtotime($renew) < strtotime('+7 days') ? 'text-warning-600 dark:text-warning-400 font-semibold' : 'text-gray-600 dark:text-gray-400'); ?>"><?php echo e($renew); ?></td>
                        <td>
                            ...
                            <?php elseif($status === 'suspended'): ?> <span class="badge badge-danger">Suspendu</span>
                            <?php else: ?> <span class="badge">Résilié</span>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/hostclient/resources/views/admin/services/index.blade.php ENDPATH**/ ?>