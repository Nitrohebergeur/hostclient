...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <form method="POST" action="<?php echo e(route('admin.products.categories.store')); ?>" class="card">
        <?php echo csrf_field(); ?>
        <div class="card-body space-y-4">
            <div class="grid md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="slug" value="<?php echo e(old('slug')); ?>" class="form-input" placeholder="Auto-généré">
                </div>
            </div>
            <div>
                <label class="form-label">Description</label>
                <textarea name="description" rows="2" class="form-input"><?php echo e(old('description')); ?></textarea>
            </div>
            <div class="grid md:grid-cols-2 gap-4">
                <div>
                    <label class="form-label">Icône <span class="text-xs text-gray-400">(classe FontAwesome)</span></label>
                    <input type="text" name="icon" value="<?php echo e(old('icon')); ?>" class="form-input" placeholder="fas fa-globe">
                </div>
                <div>
            ...
            <div class="flex items-center gap-3">
                ...
                <input type="checkbox" name="is_active" value="1" id="is_active" class="rounded" <?php if(old('is_active', true)): echo 'checked'; endif; ?>>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/hostclient/resources/views/admin/products/categories/create.blade.php ENDPATH**/ ?>