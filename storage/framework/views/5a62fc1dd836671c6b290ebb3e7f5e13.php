...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label, $amount, $color]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="card">
            <div class="card-body py-4">
                <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($label); ?></p>
                <p class="text-2xl font-bold text-<?php echo e($color); ?>-600 dark:text-<?php echo e($color); ?>-400 mt-1"><?php echo e($amount); ?></p>
            </div>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="table w-full">
                ...
                <tbody>
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$num, $client, $desc, $amount, $issued, $due, $gw, $status]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><input type="checkbox" class="w-4 h-4 rounded border-gray-300"></td>
                        <td><a href="/admin/invoices/1" class="font-mono text-primary-600 dark:text-primary-400 hover:underline text-sm">#<?php echo e($num); ?></a></td>
                        <td class="font-medium text-gray-900 dark:text-white text-sm"><?php echo e($client); ?></td>
                        <td class="text-gray-600 dark:text-gray-400 text-sm max-w-40 truncate"><?php echo e($desc); ?></td>
                        <td class="font-bold text-gray-900 dark:text-white"><?php echo e($amount); ?></td>
                        <td class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($issued); ?></td>
                        <td class="text-sm <?php echo e($status === 'overdue' ? 'text-danger-600 dark:text-danger-400 font-semibold' : 'text-gray-600 dark:text-gray-400'); ?>"><?php echo e($due); ?></td>
                        <td>
                            <span class="text-xs font-medium px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full"><?php echo e($gw); ?></span>
                        </td>
                        <td>
                            ...
                            <?php elseif($status === 'overdue'): ?> <span class="badge badge-danger">En retard</span>
                            <?php elseif($status === 'cancelled'): ?> <span class="badge">Annulée</span>
                            <?php else: ?>                         <span class="badge badge-primary">Remboursée</span>
                        ...
                        <td>
                            <div class="flex items-center gap-1">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($status === 'pending' || $status === 'overdue'): ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/hostclient/resources/views/admin/invoices/index.blade.php ENDPATH**/ ?>