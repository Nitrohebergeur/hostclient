...
class LicenseDomainAllowlistTest extends TestCase
{
    ...
    public function test_attacker_domain_is_rejected_and_falls_back_to_canonical(): void
    {
        $this->withCtxDomain('https://attacker.example/', function () {
            $this->assertSame('https://Hostclient.com', LicenseGateway::getDomain());
        });
    }

    public function test_http_scheme_is_rejected(): void
    {
        $this->withCtxDomain('http://Hostclient.com', function () {
            $this->assertSame('https://Hostclient.com', LicenseGateway::getDomain());
        });
    }
    ...
    {
        $this->withCtxDomain('https://staging.Hostclient.com', function () {
            $this->assertSame('https://staging.Hostclient.com', LicenseGateway::getDomain());
        });
    }
    ...
    {
        $this->withCtxDomain('https://Hostclient.com.attacker.example', function () {
            $this->assertSame('https://Hostclient.com', LicenseGateway::getDomain());
        });
    }
}
