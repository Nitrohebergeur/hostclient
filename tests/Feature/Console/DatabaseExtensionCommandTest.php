...
class DatabaseExtensionCommandTest extends TestCase
{
    ...
    {
        Artisan::call('Hostclient:db-extension', ['--extension' => '../../tmp/evil']);
    ...
    {
        Artisan::call('Hostclient:db-extension', ['--extension' => 'evil/path']);
        $this->assertStringContainsString('Invalid extension identifier', Artisan::output());
    }

    public function test_db_extension_rejects_special_chars(): void
    {
        Artisan::call('Hostclient:db-extension', ['--extension' => 'evil; rm -rf /']);
        $this->assertStringContainsString('Invalid extension identifier', Artisan::output());
    }

    public function test_db_extension_accepts_valid_identifier(): void
    {
        Artisan::call('Hostclient:db-extension', ['--extension' => 'valid-name_123']);
    ...
    {
        Artisan::call('Hostclient:db-extension');
