                    ...
                    <div class="p-4 md:p-6">
                        ...
                        <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-200 dark:hover:text-white">
                            @if ($group->badge_title)
                                <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium mb-1" style="background-color: {{ $group->badge_color ?: '#e0e7ff' }}; color: {{ app('theme')->getContrastColor($group->badge_color ?: '#e0e7ff') }};">
                                    @if($group->badge_icon)
