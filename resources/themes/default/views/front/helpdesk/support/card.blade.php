    ...
    <div class="card-heading">
        <div>
            <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200">
                {{ __('helpdesk.support.index') }}
            </h2>
            <p class="text-sm text-gray-600 dark:text-gray-400">
                {{ __('helpdesk.support.index_description') }}
            </p>
        </div>
            ...
            @foreach($tickets as $i => $ticket)
                <tr class="bg-white hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800">
                    ...
                    <span class="block px-6 py-2">
                      <span class="text-sm text-gray-600 dark:text-gray-400">{{ $ticket->excerptSubject() }}</span>
                    </span>
                    </td>
                    <td class="h-px w-px whitespace-nowrap">
                    <span class="block px-6 py-2">
                      <span class="text-sm text-gray-600 dark:text-gray-400"> <x-badge-state state="{{ $ticket->priority }}"></x-badge-state></span>
                    </span>
                    </td>
                    <td class="h-px w-px whitespace-nowrap">
