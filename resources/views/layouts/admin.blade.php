    ...
    >
        ...
        <nav class="flex-1 overflow-y-auto scrollbar-thin py-4 px-3 space-y-0.5">
            ...
            $nav = [
                ...
                ['label' => 'Rôles & Permissions','icon' => 'shield',   'route' => 'admin/roles'],
                ['divider' => 'Commerce'],
                ['label' => 'Produits',        'icon' => 'cube',        'route' => 'admin/products'],
                ['label' => 'Catégories',      'icon' => 'tag',         'route' => 'admin/categories'],
                ...
                ['divider' => 'Services'],
                ['label' => 'Services',        'icon' => 'server',      'route' => 'admin/services'],
                ...
                ['divider' => 'Système'],
                ['label' => 'Plugins',         'icon' => 'puzzle',      'route' => 'admin/plugins'],
