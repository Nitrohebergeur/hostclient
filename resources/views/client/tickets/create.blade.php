                ...
                <div>
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        ...
                        <label class="relative cursor-pointer">
                            <input type="radio" name="priority" value="{{ $prio[0] }}" class="peer sr-only" {{ $prio[0] === 'normal' ? 'checked' : '' }}>
                            <div class="border-2 border-gray-200 dark:border-gray-600 peer-checked:border-primary-500 peer-checked:bg-primary-50 dark:peer-checked:bg-primary-900/20 rounded-xl p-3 text-center transition-all">
                                <p class="text-sm font-semibold text-gray-900 dark:text-white">{{ $prio[1] }}</p>
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ $prio[2] }}</p>
                            </div>
                        </label>
                        @endforeach
                    </div>
