...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        <div class="card">
            <div class="card-body text-center py-4">
                <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ $stat[0] }}</p>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ $stat[1] }}</p>
            </div>
        </div>
        @endforeach
    </div>
    ...
    <div class="space-y-3">
        ...
        <a href="/client/tickets/{{ $ticket[0] }}" class="card hover:shadow-md transition-all block group">
            <div class="card-body">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        @elseif($ticket[3] === 'En cours')
                            <span class="badge badge-primary">En cours</span>
                        @elseif($ticket[3] === 'En attente')
