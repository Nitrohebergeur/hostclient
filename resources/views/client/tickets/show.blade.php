...
<div class="space-y-6">
    ...
    <div class="grid lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-4">
            ...
            <div class="card {{ $msg[0] === 'staff' ? 'border-l-4 border-primary-500' : '' }}">
                <div class="card-body">
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center gap-3">
                            <img src="https://ui-avatars.com/api/?name={{ urlencode($msg[1]) }}&background={{ $msg[0] === 'staff' ? '0ea5e9' : '6366f1' }}&color=fff&size=40" class="w-10 h-10 rounded-full">
                            <div>
                                <p class="font-semibold text-gray-900 dark:text-white">{{ $msg[1] }}</p>
                                @if($msg[0] === 'staff')
                                    <span class="badge badge-primary text-xs">Staff</span>
                                @endif
                            </div>
                        </div>
                        <span class="text-sm text-gray-500 dark:text-gray-400">{{ $msg[2] }}</span>
                    </div>
        ...
        <div class="space-y-4">
            ...
            <div class="card">
                ...
                <div class="card-body space-y-2">
                    @foreach(['Merci pour votre réponse rapide !', 'Problème résolu, merci.', 'J\'ai besoin de plus d\'informations.'] as $quick)
