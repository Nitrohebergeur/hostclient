        ...
        <div class="overflow-x-auto">
            <table class="table w-full">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <a href="/client/invoices/{{ strtolower($inv[0]) }}" class="font-medium text-primary-600 dark:text-primary-400 hover:underline">
                                #{{ $inv[0] }}
                            </a>
                        </td>
                        <td class="text-gray-600 dark:text-gray-400">{{ $inv[1] }}</td>
                        <td class="text-gray-900 dark:text-white">{{ $inv[2] }}</td>
                        <td class="font-bold text-gray-900 dark:text-white">{{ $inv[3] }}</td>
                        <td>
                            @if($inv[4] === 'pending')
                                <span class="badge badge-warning">En attente</span>
                            @elseif($inv[4] === 'paid')
                                <span class="badge badge-success">Payée</span>
                            @elseif($inv[4] === 'refunded')
                        ...
                        <td>
                            <div class="flex items-center gap-2">
                                @if($inv[4] === 'pending')
                                    <a href="/client/invoices/{{ strtolower($inv[0]) }}/pay" class="btn btn-primary btn-sm">Payer</a>
                                @endif
                                <a href="/client/invoices/{{ strtolower($inv[0]) }}/pdf" class="btn btn-secondary btn-sm" title="Télécharger PDF">
