...
<div class="space-y-6">
    ...
    <div>
        ...
        <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
            ...
            ] as [$name, $desc, $active, $author, $version])
            <div class="card {{ $active ? 'border-2 border-primary-500' : '' }} hover:shadow-md transition-shadow">
                <!-- Preview -->
                <div class="h-40 bg-gradient-to-br {{ $active ? 'from-primary-500 to-secondary-600' : 'from-gray-700 to-gray-900' }} relative overflow-hidden">
                ...
                <div class="card-body">
                    ...
                    <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">Par {{ $author }} · {{ $version }}</p>
