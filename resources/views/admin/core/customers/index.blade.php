                    ...
                    <span class="block px-6 py-2">
                      <span class="inline-flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                          {{ $item->excerptFullname() }}
                                        ...
                                        <td class="h-px w-px whitespace-nowrap">
                    <span class="block px-6 py-2">
                        <span class="text-sm text-gray-600 dark:text-gray-400"><a href="mail:{{ $item->email }}">{{ Str::limit($item->email, 30) }}</a></span>
                    </span>
                                        </td>

                                        <td class="h-px w-px whitespace-nowrap">
                    <span class="block px-6 py-2">
                        <span class="text-sm text-gray-600 dark:text-gray-400"><a href="tel:{{ $item->phone }}">{{ Str::limit($item->phone, 15) }}</a></span>
                    </span>
                                        </td>

                                        <td class="h-px w-px whitespace-nowrap">
                    <span class="block px-6 py-2">
                      <span class="text-sm text-gray-600 dark:text-gray-400">{{ formatted_price($item->balance) }}</span>
                    </span>
                                        </td>
                                    <td class="h-px w-px whitespace-nowrap">

                                        <a href="{{ route($routePath . '.show', ['customer' => $item]) }}">
                                        ...
                                        @if (staff_has_permission('admin.manage_customers'))
                                        <form method="POST" action="{{ route($routePath . '.show', ['customer' => $item]) }}" class="inline confirmation-popup">
                                            @method('DELETE')
                                            @csrf
                                            <button>
